...
export const evidenceSchema = z.object({
  id: z.string(), sourceTitle: z.string(), sourceUrl: z.string().url(), excerpt: z.string().min(1), retrievedAt: z.string(), server: z.string(), toolCallId: z.string(), traceStepId: z.string()
});
...
export const rawToolResultSchema = z.object({ sources: z.array(z.object({ title: z.string(), url: z.string().url(), excerpt: z.string().min(1) })).min(1) });
