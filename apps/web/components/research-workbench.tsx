...
export function ResearchWorkbench() {
  ...
  return <div className="shell">
    <header><div className="brand"><span className="mark">R</span><span>ResearchOS</span></div><div className="header-actions"><span className="pill">MCP research runtime</span><button type="button" onClick={() => setShowBilling(true)}>Account & billing</button>{user && <button type="button" onClick={() => void signOut(firebaseAuth())}>Sign out</button>}</div></header>
