...
export function SiteHeader({ signedIn = false, credits, onSignIn, onBilling, onSignOut }: SiteHeaderProps) {
  ...
  return <><header className="app-header"><div className="app-header-inner">
    ...
    <nav className={`${open ? "public-nav open" : "public-nav"}${signedIn ? " signed-nav" : ""}`} aria-label="Site navigation">
      {!signedIn && <><a href="/about" onClick={close}>About</a><a href="/features" onClick={close}>Features</a><a href="/how-it-works" onClick={close}>How it works</a><a href="/demo" onClick={close}>Demo</a><a href="/pricing" onClick={close}>Pricing</a><a href="/faq" onClick={close}>FAQ</a><a href="/blog" onClick={close}>Blog</a><a href="/support" onClick={close}>Support</a></>}
...
export function PublicSiteFooter() {
  return <footer className="public-footer site-footer">
    ...
    <nav><a href="/about">About</a><a href="/features">Features</a><a href="/how-it-works">How it works</a><a href="/demo">Demo</a><a href="/pricing">Pricing</a><a href="/faq">FAQ</a><a href="/blog">Blog</a><a href="/support">Support</a><a href="/privacy">Privacy</a><a href="/?signin=1">Sign in</a></nav>
  </footer>;
}
